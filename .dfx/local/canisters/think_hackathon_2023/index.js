...
import { idlFactory } from './think_hackathon_2023.did.js';
export { idlFactory } from './think_hackathon_2023.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.THINK_HACKATHON_2023_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./think_hackathon_2023.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the think_hackathon_2023 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./think_hackathon_2023.did.js")._SERVICE>}
 */
export const think_hackathon_2023 = createActor(canisterId);
